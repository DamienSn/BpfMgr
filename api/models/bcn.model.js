...
module.exports.getAllByUser = (params, result) => {
    ...
    SELECT bcn_bpf_id, bcn_user_id, bpf_date, city_name, city_departement, city_poi_id, dpt_name, city_province_id, province_name, city_is_old_new_id, city_lat, city_long, user_email, user_name
    FROM bcns
