export function SuccessToast(props) {
    return (
        <div id={props.id} class="toast flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 fixed bottom-2 right-4">
...
export function InfoToast(props) {
    return (
        <div id={props.id} class="toast flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 my-5 fixed bottom-2 right-4">
            <div class="px-4 py-2 -mx-3">
                <div class="mx-3">
